...
if (isset($_GET['delete_image'])) {
    ...
    $deleteQuery = "DELETE FROM stem12hands2 WHERE image_url = '$imageToDelete'";
    if (mysqli_query($conn, $deleteQuery)) {
        if (unlink("uploads/$imageToDelete")) {
            header("Location: STEM12hands2.php");
            exit();
        } else {
...
<html lang="en">
  ...
  <body>
        ...
        <header>
            ...
            <a href="STEMTEACHER12home.php"><button class="btn">Back</button></a>
        </header>
        ...
        <section>
            <div class="left-sidebar">
                <div class="profile">
                    ...
                    <div class="student-info">
                        <p>Adviser</p>
                        <p class="strand">STEM12</p>
                        <div class="students-STEM">
                            <?php
            ...
            <div class="contain">
                <form action="STEM12uploadhands2.php" method="post" enctype="multipart/form-data">
            ...
            <div class="gallery">
                ...
                include "stemdb12.php";
                $limit = 5; 
                $sql = "SELECT * FROM stem12hands2 ORDER BY id DESC LIMIT $limit";
                $res = mysqli_query($conn, $sql);

                if (mysqli_num_rows($res) > 0) {
                    while ($stem12hands2 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            <?php 
                            $fileExtension = pathinfo($stem12hands2['image_url'], PATHINFO_EXTENSION);
                            if ($fileExtension === 'pdf') {
                                echo '<img src="img/pdficon.png" alt="PDF File">';
                            } elseif ($fileExtension === 'doc' || $fileExtension === 'docx') {
                                echo '<img src="img/wordicon.png" alt="Word File">';
                            } else {
                                echo '<img src="uploads/'.$stem12hands2['image_url'].'" alt="Uploaded Image">';
                            }
                            ?>
                            <p><?php echo $stem12hands2['filename']; ?></p>
                            <a class="delete-btn" href="stem12hands2.php?delete_image=<?=$stem12hands2['image_url']?>">
                                <img src="img/remove.png" alt="Delete" width="1" height="1">
                            </a>
                            <a class="download-btn" href="uploads/<?=$stem12hands2['image_url']?>" download="<?=$stem12hands2['image_url']?>">
