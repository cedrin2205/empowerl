...
if (isset($_GET['delete_image'])) {
    ...
    if (mysqli_query($conn, $deleteQuery)) {
        ...
        if (unlink("uploads/$imageToDelete")) {
            ...
            header("Location: ICT12hands2.php");
            exit();
        } else {
    ...
    if ($error === 0) {
        ...
        if (in_array($file_ex_lc, $allowed_exs)) {
            if ($img_size > 10000000000) {
                ...
                header("Location: ICT12hands2.php?error=$em");
                exit();
            } else {
                ...
                $insertQuery = "INSERT INTO ict12hands2 (image_url, filename) VALUES ('$new_img_name', '$img_name')";
