...
if (isset($_GET['delete_image'])) {
    ...
    $deleteQuery = "DELETE FROM ict12hands1 WHERE image_url = '$imageToDelete'";
...
<html lang="en">
  <head>
      ...
      <title>ICT Handout 1 and 2</title>
...
.contain form input[type="file"] {
  ...
  <body>
        <header>
            ...
            <h2 class="logo">ICT 12 Handout 1 and 2</h2>
        ...
        <section>
            ...
            <div class="contain">
                <form action="ICT12handsupload1.php" method="post" enctype="multipart/form-data">
                ...
                if (mysqli_num_rows($res) > 0) {
                    while ($ict12hands1 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            ...
                            <a class="delete-btn" href="ict12hands1.php?delete_image=<?=$ict12hands1['image_url']?>">
...
<script>
                ...
                xhttp.open("GET", "ict12hands1.php?mark_as_seen=" + encodeURIComponent(imageUrl), true);
                xhttp.send();
